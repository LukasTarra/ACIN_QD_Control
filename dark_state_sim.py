...
===========================
Runs the six-level system from pyaceqd to simulate QD dark states
Parameters are provided as params from running the getparameters.py file.
...
def sixls_linear(t_start, t_end, *pulses, dt=0.5, phonons=False, verbose=False, lindblad=False, temp_dir='/mnt/temp_data/', pt_file=None, suffix="", \
               multitime_op=None, pulse_file_x=None, pulse_file_y=None, prepare_only=False, output_ops=["|0><0|_6","|1><1|_6","|2><2|_6","|3><3|_6"], initial="|0><0|_6", t_mem=20.48, output_dm=False, dressedstates=False, rf=False, rf_file=None,
         firstonly=False,calibration_file=None):
